...
public class MovieAdapterRecycler extends RecyclerView.Adapter<MovieAdapterRecycler.MyViewHolder> {

    private Context context;
    private List<Film> films = new ArrayList<>();
    private OnFilmListener  mOnFilmListener;

    public MovieAdapterRecycler(Context context, OnFilmListener onFilmListener) {
